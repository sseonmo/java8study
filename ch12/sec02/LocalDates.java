...
public class LocalDates {
	public static void main(String[] args) {
		...
		System.out.println(programmersDay.plus(Period.ofYears(1)));
//		System.out.println(programmersDay.plus(Duration.ofDays(365)));
		...
		DayOfWeek test = LocalDate.of(1900, 1, 1).minusDays(1).getDayOfWeek();
