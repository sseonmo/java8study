...
//			Integer[] numbers2 = (Integer[]) numbers; // Throws exception
			Integer[] numbers3 = (Integer[]) Stream.of(numbers).toArray(Integer[]::new);
			System.out.println(Arrays.toString(numbers3)); // Note it's an Object[] array
		...
		IntSummaryStatistics summary = noVowels("alice.txt").collect(
				Collectors.summarizingInt((v) -> (v.length()+1)*Math.round(10)));
