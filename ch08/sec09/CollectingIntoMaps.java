...
public class CollectingIntoMaps {
	...
	public static Stream<Person> people1() {
		return Stream.of(new Person(1001, "Peter"), new Person(1002, "Paul"), new Person(1003,
				"Mary"), new Person(1001, "Peter2"));
	}
	...
	public static void main(String[] args) throws IOException {
		...
		Map<Integer, Person> idToPerson1= people1().collect(
...
//					return existingValue;
		...
		System.out.println("idToPerson: " + idToPerson1.getClass().getName() + idToPerson);
